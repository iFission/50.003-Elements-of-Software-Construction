...
public class BrokenLinkFinderNoSmell {
	...
	// gets acknowledge message from hyperlink
	public static String getAcknowledgeMessage(URL hyperLink) throws Exception {
	...
	public static void brokenLinkChecker(URL hyperLink) throws Exception {
		...
		try {
			acknowledge = getAcknowledgeMessage(hyperLink);
