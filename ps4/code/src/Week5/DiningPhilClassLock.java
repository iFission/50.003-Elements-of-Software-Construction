...
public class DiningPhilFixed1 {
	/*
	implement class lock around the critical section
	only 1 philosopher is able to pick up both forks and eat
	others must wait until that philosopher puts down both forks
	*/
