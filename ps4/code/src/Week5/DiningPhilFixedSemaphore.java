...
public class DiningPhilFixedSemaphore {
	private static int N = 20;
	public static Semaphore eat = new Semaphore(1);
	...
	synchronized public void run() {
		...
		try {
			while (true) {
				...
				DiningPhilFixedSemaphore.eat.acquire();
				left.pickup();
				...
				DiningPhilFixedSemaphore.eat.release();
			}
